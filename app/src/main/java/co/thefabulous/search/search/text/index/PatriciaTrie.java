...
import co.thefabulous.search.search.common.Strings;
import co.thefabulous.search.search.data.ScoredObject;
import co.thefabulous.search.search.text.match.Automaton;
import co.thefabulous.search.search.text.match.EqualityAutomaton;
import co.thefabulous.search.search.util.ArraySet;
